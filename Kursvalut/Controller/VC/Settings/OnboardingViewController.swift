...
class OnboardingViewController: UIViewController {
    ...
    private let slides = [
        ...
        OnboardingSlide(title: "Валюты", iconName: "globe.europe.africa.fill", subtitle: "Здесь вы можете следить за актуальным курсом валют, видеть насколько он изменился по сравнению со вчерашним днём. \n \n Пользователи Pro могут настроить свой порядок.", imageName: "changeCellOrder", tutorialData: [(icon: K.Images.circleOne, text: "Откройте Настройки → Сортировка → Своя → Включить"), (icon: K.Images.circleTwo, text: "Смахните справа налево по любой из ячеек"), (icon: K.Images.circleThree, text: "Нажмите на синюю иконку с тремя линиями"), (icon: K.Images.circleFour, text: "Удерживая палец на серой иконке с тремя линиями перемещайте ячейку вверх/вниз"), (icon: K.Images.checkmarkCircle, text: "Нажмите «Готово». Всё! 🎉")]),
        OnboardingSlide(title: "Валюты", iconName: "globe.europe.africa.fill", subtitle: "Данные по курсу автоматически загружаются приложением один раз в день (во время первого захода в приложение). \n \n Но вы всегда можете самостоятельно запросить обновление.", imageName: "updateCellData", tutorialData: [(icon: K.Images.circleOne, text: "Потяните таблицу с валютами вниз"), (icon: K.Images.circleTwo, text: "Отпустите, когда почувствуете легкую вибрацию от смартфона"), (icon: K.Images.checkmarkCircle, text: "По результату сверху отобразится всплывающее уведомление! 👌🏻")]),
        OnboardingSlide(title: "Конвертер", iconName: "arrow.left.arrow.right", subtitle: "Тут можно конвертировать валюты. Конвертация будет синхронная для всех валют на экране. Чтобы ввести число нажмите на правую часть ячейки с нужной валютой. \n \n Экран полностью настраивается: вы можете удалять и менять местами добавленные валюты.", imageName: "changeConverterCell", tutorialData: [(icon: K.Images.circleOne, text: "Смахните справа налево по любой из ячеек"), (icon: K.Images.circleTwo, text: "Нажмите на красную иконку с корзиной для удаления"), (icon: K.Images.circleThree, text: "Нажмите на синюю иконку с тремя линиями для редактирования порядка расположения"), (icon: K.Images.circleFour, text: "Удерживая палец на серой иконке с тремя линиями перемещайте ячейку вверх/вниз"), (icon: K.Images.checkmarkCircle, text: "Нажмите «Готово». Всё! 🎉")]),
        OnboardingSlide(title: "Конвертер", iconName: "plus", subtitle: "Чтобы добавить/удалить валюту нужно перейти на экран со списком всех доступных валют.", imageName: "pickCurrencyForConverter", tutorialData: [(icon: K.Images.circleOne, text: "Нажмите на значок «+» в правом верхнем углу экрана Конвертер"), (icon: K.Images.circleTwo, text: "Далее найдите нужную валюту и нажмите на ячейку с ней"), (icon: K.Images.circleThree, text: "Если слева появилась галочка - валюта добавлена в конвертер"), (icon: K.Images.circleFour, text: "Чтобы удалить валюту из конвертера, повторно коснитесь ячейки"), (icon: K.Images.checkmarkCircle, text: "Нажмите «Готово». Всё! 🎉")])
    ]
...
extension OnboardingViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.item == 0 {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: K.Cells.welcomeOnboardingCellKey, for: indexPath) as! WelcomeOnboardingCollectionViewCell
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: K.Cells.onboardingCellKey, for: indexPath) as! OnboardingCollectionViewCell
...
extension OnboardingViewController {
    ...
    func showPreviousButton() {
        previousButton.setBackgroundImage(UIImage(systemName: K.Images.chevronBackward), for: .normal)
        previousButton.isUserInteractionEnabled = true
    }
    
    func hidePreviousButton() {
        previousButton.setBackgroundImage(UIImage(systemName: K.Images.chevronLeftCircle), for: .normal)
